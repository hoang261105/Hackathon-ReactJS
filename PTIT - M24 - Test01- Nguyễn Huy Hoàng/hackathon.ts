...
class Feedbacks {
    ...
    renderFeedBack(): void {
        let feedBackList = document.querySelector(".comment-bottom") as HTMLInputElement;
    ...
    createFeedBack(name: string, score: number): void {
    ...
    updateFeedBack(id: number): void {
        ...
        document.querySelectorAll(`.change-color[data-num="${selectedNumber}"]`).forEach((element: any) => {
...
let inputField = document.getElementById("comment") as HTMLInputElement;
let selectedNumber: number | null = null;
let sendFeedback = document.getElementById("send") as HTMLInputElement;
let saveFeedback = document.getElementById("save") as HTMLInputElement;
